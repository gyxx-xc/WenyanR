...
if_statement                : IF if_expression ZHE if+=statement* (ELSE else+=statement*)? FOR_IF_END ;
...
for_statement               : FOR_ARR_START data FOR_ARR_BELONG IDENTIFIER statement* FOR_IF_END  # for_arr_statement
                            | FOR_ARR_START data FOR_ARR_BELONG statement* FOR_IF_END             # for_enum_statement
